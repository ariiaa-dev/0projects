...
import {AiOutlineLineChart, AiOutlineAppstore, AiOutlineUser, AiOutlineShoppingCart,AiOutlineCamera,AiOutlineFile,} from 'react-icons/ai'
            ...
            <SimpleBarReact style={{height:"calc(100% - 70px)"}}> 
                <ul className="sidebar-menu border-t border-white/10">
                    <li className={["","/"].includes(manu)? "active" : ""}>
                        <Link href="/"><AiOutlineLineChart className=" me-3 icon "/> Dashboard</Link>
                    </li>
