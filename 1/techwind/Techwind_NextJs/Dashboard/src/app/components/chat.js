            ...
            <div className="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-800 p-4">
                    ...
                    <div className="dropdown relative">
                        ...
                        <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 ${manu ? '' : 'hidden'}`}>
                            ...
                            <div className="inline-block">
                                <div className="flex mb-3">
                                    <div className="relative">
                                        <Image src='/images/client/01.jpg' height={36} width={36} className="h-9 w-9 min-w-[36px] rounded-full shadow dark:shadow-gray-700" alt=""/>
                            ...
                            <div className="inline-block">
                                <div className="flex mb-3">
                                    <div className="relative order-2">
                                        <Image src='/images/client/05.jpg' height={36} width={36} className="h-9 w-9 min-w-[36px] rounded-full shadow dark:shadow-gray-700" alt=""/>
