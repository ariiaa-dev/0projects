...
export default function ShopItemDetail(props) {
    const data = productData.find((product) => product.id === parseInt(props.params.id))
                ...
                <div className="p-6 rounded-md mt-6 shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-6 items-center">
                        <div className="xl:col-span-4 lg:col-span-5 md:col-span-6">
                            <Image src={data?.image} width={0} height={0} sizes="100vw" placeholder="blur" blurDataURL={data?.image} style={{width:'100%', height:'auto'}} className="rounded-md shadow dark:shadow-gray-800" alt="" />
                        </div>
