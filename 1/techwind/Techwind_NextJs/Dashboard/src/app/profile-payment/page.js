                                            ...
                                            return(
                                                <li className="flex justify-between items-center py-6" key={index}>
                                                    <div className="flex items-center">
                                                        <Image src={item.image} width={48} height={32} className="rounded shadow dark:shadow-gray-700 w-12" alt=""/>
                                                    ...
                                                    <div>
                                                        <Link href="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full"><Icon.Trash2 className="h-4 w-4"/></Link>
                                                    </div>
                                                </li>
                                            )
                                        })}
