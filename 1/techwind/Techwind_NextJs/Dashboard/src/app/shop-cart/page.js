        ...
        <div className="container-fluid relative px-3">
            <div className="layout-specing">
                ...
                <div className="grid grid-cols-1 mt-6">
                    <div className="relative overflow-x-auto shadow dark:shadow-gray-700 rounded-md">
                                        ...
                                        <tr className="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-gray-800" key={index}>
                                            ...
                                            <td className="p-4">
                                                <span className="flex items-center">
                                                    <Image src={item.image} width={48} height={60} placeholder="blur" blurDataURL={item.image} className="rounded shadow dark:shadow-gray-700 w-12" alt=""/>
                                                    <span className="ms-3">
                                            ...
                                            <td className="p-4 text-center">
                                                <div className="qty-icons space-x-1">
                                                    <button className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white minus">-</button>
                                                    ...
                                                    <button className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white plus">+</button>
                                                </div>
                                            </td>
                    ...
                    <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                        ...
                        <div className="lg:col-span-3 md:order-2 order-1">
                            <ul className="list-none shadow dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900">
